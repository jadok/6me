...
import { Buy as BuyType, Product, Localization as LocalizationType, ProductsPrefillData } from '@graphql-types@';
...
export const BuyEdit = ({ buyData, prefill, addBuy }: BuyProps): JSX.Element => {
